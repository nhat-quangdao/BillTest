...
public class CorrectedBill
{
  ...
  //test helper methods
  public boolean stateExpected(String state) {
	  return billState == BillState.valueOf(state);
  }
  
  public boolean houseStateExpected(String state) {
	  return billStateInHouseOfCommons == BillStateInHouseOfCommons.valueOf(state);
  }
  
  public boolean senateStateExpected(String state) {
	  return billStateInSenate == BillStateInSenate.valueOf(state);
  }
